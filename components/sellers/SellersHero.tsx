			...
			<div
				...
				<div
					...
					<video
						...
						<source
							src="https://redesign-media.s3.eu-north-1.amazonaws.com/michaud-rauer/66ndeerhaven3.mp4"
							type="video/mp4"
						/>
			...
			<div className="relative z-10 px-[5%] lg:px-[10%] xl:px-[15%] flex flex-col items-start justify-start w-full h-full text-white">
				<motion.div
					...
					<motion.p
						...
						variants={itemVariants}>
						To make the selling process as stress-free as possible
					</motion.p>

					<motion.div
						className="flex flex-col sm:flex-row gap-6 w-full mt-8"
						variants={itemVariants}>
						<a
							href="#seller-process"

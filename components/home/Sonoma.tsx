			...
			<div className="">
				<motion.div
					...
					<motion.h1
						custom={1}
						variants={textVariants}
						className="text-7xl xl:text-9xl font-light text-zinc-600 tracking-wider text-center">
						SONOMA
					</motion.h1>
					...
					<motion.div
						...
						<div className="text-center mb-16 px-8 md:px-0">
							<h3 className="text-3xl text-zinc-800 font-light uppercase tracking-widest mb-8">
								AMENITIES
							</h3>
							<p className="text-zinc-600 text-base mb-4 max-w-4xl mx-auto text-center font-extralight">

...
const Hero = () => {
	...
	// Third property from our config
	const propertyVideo = config.properties.foster2324;
			...
			<div className="relative z-10 px-[5%] lg:px-[10%] xl:px-[15%] flex flex-col items-start justify-start w-full h-full text-white">
				<motion.div
					...
					<motion.p
						...
						variants={itemVariants}>
						Proven Success in Lake Geneva area
					</motion.p>
					...
					<motion.div
						...
						<motion.button
							onClick={() => {
								...
								if (statsSection) {
									smoothScrollTo(statsSection.offsetTop);
								}
							}}
						...
						<motion.button
							...
							whileTap={{ scale: 0.98 }}>
							<span className="sm:ml-2">TESTIMONIALS</span>
						</motion.button>
					</motion.div>
				</motion.div>
			</div>

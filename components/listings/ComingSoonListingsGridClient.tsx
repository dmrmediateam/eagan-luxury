...
interface ComingSoonListingsGridClientProps {
...
const ComingSoonListingsGridClient: React.FC<
	ComingSoonListingsGridClientProps
> = ({ listings, showAll, itemsPerPage }) => {
	...
	// Use full list if showAll=false, otherwise paginate
	const currentListings = showAll
		? listings.slice(startIndex, endIndex)
		: listings.slice(0, 4); // Limit to 4 if not showAll
...
export default ComingSoonListingsGridClient;

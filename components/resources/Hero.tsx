...
const Hero = () => {
	...
	// Use the next property from config (lonmel777)
	const propertyVideo = config.properties.lonmel777;
					...
					<motion.div
						...
						<motion.button
							onClick={() => {
								...
								if (faqSection) {
									smoothScrollTo(faqSection.offsetTop);
								}
							}}
							...
							whileTap={{ scale: 0.98 } as const}>
							<Link href="#faq" className="sm:ml-2">
								FAQs
							</Link>
						</motion.button>
					</motion.div>
